...
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f2.model.Dto.RollDto;
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f2.model.Entity.Player;
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f2.model.Entity.Roll;
...
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f2.model.Repository.PlayerRepository;
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f2.model.Service.AleatoryDiceMethod.extraMethodsForRoller;
...
public class DiceGameServiceImplem implements PlayerInterface, RollInterface {
     ...
     */
    private void averageSuccessRateGetONE(PlayerDto playerDto) {
    ...
    public RankingDto getPlayerWithTheWorstLossRate() {
        ...
        if (playerRepository.findAll().isEmpty()) {
            try {
                throw new NameRepetitiveException("There are not Players introduced in the database");
            } catch (NameRepetitiveException e) {
                throw new RuntimeException(e);
            }
        } else {
            // listPlayerDto = convertListOfPlayerToListOfPLayerDTO();
            listPlayerDto = getAllUsersInTheGame();
            rankingDto = worstLoserRateMethod(averageSuccessRate(listPlayerDto));
        }
        return rankingDto;
