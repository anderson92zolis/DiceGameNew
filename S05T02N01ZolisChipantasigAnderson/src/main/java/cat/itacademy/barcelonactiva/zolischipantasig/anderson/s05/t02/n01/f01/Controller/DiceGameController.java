package cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f01.Controller;
...
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f01.model.Message.Message;
import cat.itacademy.barcelonactiva.zolischipantasig.anderson.s05.t02.n01.f01.model.Service.DiceGameServiceImplem;
...
public class DiceGameController {
    ...
    private DiceGameServiceImplem diceGameServiceImplem;
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<PlayerDto> updatePlayer(@PathVariable int id, @RequestBody PlayerDto playerDtoRequest) {
    ...
    public ResponseEntity<PlayerDto> createRolls(@PathVariable(name = "id") int id) {
    ...
    public ResponseEntity<Message> deleteRollsofAPlayer(@PathVariable(name = "id") int id) {
    ...
    public ResponseEntity<PlayerDto> deletePost(@PathVariable(name = "id") int id) throws ResourceNotFoundException {
    ...
    public ResponseEntity<?> getAllPlayers() {
        ...
        try {
            ...
            return ResponseEntity.ok()
                    .header("Custom-Header", "DICEGAME")
                    .body("THERE IS NOT PLAYER IN THE **DICEGAME**");
    ...
    /**
     * Retrieves a player's information based on their unique identifier.
     *
     * @param id The unique identifier of the player to retrieve.
     * @return A ResponseEntity object containing the PlayerDto object with the retrieved player's information and an HTTP status of 200 (OK) if the player is found, or a Message object with an HTTP status of 404 (Not Found) if the player is not found.
     * @throws ResourceNotFoundException if the requested resource is not found
     */
    @GetMapping("/{id}/games")
    public ResponseEntity<PlayerDto> getPlayerById(@PathVariable(name = "id") int id) throws ResourceNotFoundException {
        if (diceGameServiceImplem.exitsById(id)) {
    ...
    public ResponseEntity<?> getOverageRankingOfAllPlayer() {
        ...
        try {
            ...
            RankingDto rankingDto = diceGameServiceImplem.getOverageRankingOfAllPlayer();
